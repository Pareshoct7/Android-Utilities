...
public class DeviceUtil extends C
{
    ...
    public final String getIMEI() {
        if(!permissionsUtil.isPermissionGranted(Manifest.permission.READ_PHONE_STATE))
    ...
    public final boolean isNetworkAvailable() {
        ConnectivityManager cm = (ConnectivityManager) activity.getApplicationContext().getSystemService(Activity.CONNECTIVITY_SERVICE);
    ...
    public final String getNetworkType()
    {
        ...
        else if (activeNetwork.getType() == ConnectivityManager.TYPE_WIFI  || activeNetwork.getType() == ConnectivityManager.TYPE_WIMAX)
        {
